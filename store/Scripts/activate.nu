...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Alex\PycharmProjects\store-server\store'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Alex\PycharmProjects\store-server\store\Scripts\deactivate.nu'
